 ...
 * 2016-01-14T17:15:10.435+08:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "HelloWSImplService", 
                  wsdlLocation = "http://219.244.92.58:8989/webServices_CXF/HelloWS?wsdl",
                  targetNamespace = "http://webServices_CXF.mervyn.github.org/") 
public class HelloWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://webServices_CXF.mervyn.github.org/", "HelloWSImplService");
    public final static QName HelloWSImplPort = new QName("http://webServices_CXF.mervyn.github.org/", "HelloWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://219.244.92.58:8989/webServices_CXF/HelloWS?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://219.244.92.58:8989/webServices_CXF/HelloWS?wsdl");
        }
        WSDL_LOCATION = url;
    }
